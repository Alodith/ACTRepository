                    ...
                    if (TryGetIconLocation(locatable, out var iconLocation))
                    {
                       ...
                       rectTransform.anchoredPosition = iconLocation;
                        ...
                        if (resetPing == true)
                        {
                            ...
                            locatable.IsPinged = false;
                        }

                        if (!locatable.IsPinged)
                        {
                           ...
                           // print((localX + localY) + ("               ") + (pingSize * pingSize));
                            ...
                            if (localX + localY  < (pingSize * pingSize))
                            {
                                ...
                                locatableIconDictionary.TryGetValue(locatable, out icon);
                                icon.GetComponent<Animation>().Play("Ping");
